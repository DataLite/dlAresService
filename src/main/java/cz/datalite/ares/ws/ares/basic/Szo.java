 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CZO" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3}clen" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class Szo {
     ...
     * 
     */
    public List<Clen> getCZO() {
        if (czo == null) {
            czo = new ArrayList<Clen>();
        }
        return this.czo;
    }
