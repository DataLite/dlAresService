...
/**
 * Údaje o zřizovateli odštěpného závodu
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ZOZ" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3}angazma" maxOccurs="unbounded"/&gt;
...
public class ZrizovateleOZ {
     ...
     * 
     */
    public List<Angazma> getZOZ() {
        if (zoz == null) {
            zoz = new ArrayList<Angazma>();
        }
        return this.zoz;
    }
