 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CSS" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3}clen" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class Sos {
     ...
     * 
     */
    public List<Clen> getCSS() {
        if (css == null) {
            css = new ArrayList<Clen>();
        }
        return this.css;
    }
