 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CS" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3}angazma" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ClenoveSdruzeni {
     ...
     * 
     */
    public List<Angazma> getCS() {
        if (cs == null) {
            cs = new ArrayList<Angazma>();
        }
        return this.cs;
    }
