 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DIK" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3}angazma" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class Druzstevnici {
    ...
    @XmlElement(name = "DIK")
    protected List<Angazma> dik;
    @XmlElement(name = "T")
    protected List<TextType> t;

    /**
     * Gets the value of the dik property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dik property.
     * 
     * <p>
     ...
     * 
     */
    public List<Angazma> getDIK() {
        if (dik == null) {
            dik = new ArrayList<Angazma>();
        }
        return this.dik;
    }
