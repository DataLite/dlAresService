 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CSP" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3}clen" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class Sop {
     ...
     * 
     */
    public List<Clen> getCSP() {
        if (csp == null) {
            csp = new ArrayList<Clen>();
        }
        return this.csp;
    }
