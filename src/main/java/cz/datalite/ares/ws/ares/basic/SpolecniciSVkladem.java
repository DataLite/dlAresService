 ...
 *       &lt;sequence&gt;
 *         &lt;element name="SS" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3}angazma" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class SpolecniciSVkladem {
     ...
     * 
     */
    public List<Angazma> getSS() {
        if (ss == null) {
            ss = new ArrayList<Angazma>();
        }
        return this.ss;
    }
