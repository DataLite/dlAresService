 ...
 *         &lt;element name="Vypis_RZP" type="{http://wwwinfo.mfcr.cz/ares/xml_doc/schemas/ares/ares_datatypes/v_1.0.3}vypis_RZP" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class OdpovedRZP {
    ...
    protected List<VypisRZP> vypisRZP;
     ...
     * 
     */
    public List<VypisRZP> getVypisRZP() {
        if (vypisRZP == null) {
            vypisRZP = new ArrayList<VypisRZP>();
        }
