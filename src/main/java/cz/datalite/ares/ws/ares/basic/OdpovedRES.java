...
@XmlType(name = "odpoved_RES", propOrder = {
    "pid",
    "e",
    "vh",
    "pza",
...
public class OdpovedRES {
    ...
    protected List<VypisRES> vypisRES;
     ...
     * 
     */
    public List<VypisRES> getVypisRES() {
        if (vypisRES == null) {
            vypisRES = new ArrayList<VypisRES>();
        }
